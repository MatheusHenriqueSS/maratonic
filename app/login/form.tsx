...
export const LoginForm = () => {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    return toast.info('We sent you a login link via email. Be sure to check spam.', {
        position: "bottom-right",
        autoClose: false,
  ...
  return (
    <div className="space-y-6">
            <form onSubmit={onSubmit}>
                ...
                <h3 className="text-xl font-medium text-gray-900 dark:text-white">Sign in to MaratonIC</h3>
                <div>
                    <label htmlFor="email" className="mt-2 text-sm font-medium text-gray-900 block mb-2 dark:text-gray-300">Your email</label>
                    <input onChange={handleChange} value={formValues.email} type="email" name="email" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Email address" required/>
                </div>
                <button 
                disabled={loading}
                type="submit" 
